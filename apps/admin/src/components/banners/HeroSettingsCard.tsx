    ...
    <Card>
      <form onSubmit={handleSubmit(saveSettings)}>
                  ...
                  <div className="flex items-start gap-2 rounded-lg border border-warning bg-warning/10 p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-warning-foreground/80">
                        Please set a banner as primary to use Image or Video
                        mode. Go to the banners table below and click "Set as
                        Primary" on a banner.
                      </p>
                    </div>
                  </div>
        ...
        <CardFooter className="flex gap-3">
          <Button disabled={isLoading || isSaving} className="w-32">
            Save
          </Button>
          <Button
            variant="outline"
